  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto relative">
        ...
        <motion.h2
          className="absolute inset-0 text-4xl md:text-6xl lg:text-7xl font-serif leading-tight text-center bg-gradient-to-r from-rose-400 via-pink-300 to-rose-400 bg-clip-text text-transparent"
          style={{ clipPath }}
        >
          Каждая любовь —
          <br />
